...
import { Archive, ArchiveRestore, Trash2, Maximize2, Minimize2 } from 'lucide-react'
...
export function NotebookHeader({ notebook, focusMode = false, onFocusModeToggle }: NotebookHeaderProps) {
